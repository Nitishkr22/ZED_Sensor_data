...
def main():
    ...
    stop_distance = 10  # in meteres in front of car
    detecting_distance = 35         #
    caution_distance = 15  # in  actual 13.6 m
            ...
            if len(obj_array) > 0:
                ...
                for obj in objects.object_list:
                    ...
                    if (obj.raw_label in class_limit and obj.position[0] < detecting_distance):
                        ...
                        if (obj.position[1] > left_right_distance and angle > -180 and angle < -90):
                            color = (0, 128, 255)
                            flag = 1
                        if (obj.position[1] < -left_right_distance and angle > -90 and angle < 0):
                            color = (0, 128, 255)
                            flag = 1
